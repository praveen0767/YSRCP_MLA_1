...
export function Footer() {
  return (
    <footer className="bg-slate-50 text-slate-600 border-t border-slate-200">
      <div className="w-full max-w-[1800px] mx-auto px-6 md:px-12 pt-24 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 mb-20">
          
          {/* Brand & Mission */}
          <div className="lg:col-span-4 flex flex-col space-y-8">
            <div className="flex items-center space-x-4">
              <div className="relative w-14 h-14 overflow-hidden rounded-none border border-slate-200 bg-white shadow-sm">
                <Image src="/logo.jpeg" alt="Logo" fill sizes="56px" className="object-cover" />
              </div>
              <div className="flex flex-col">
                <span className="text-xl font-black text-slate-900 leading-none tracking-tighter uppercase">KUNCHE RAMANARAO</span>
                <span className="text-[10px] font-bold text-primary uppercase tracking-[0.3em] mt-1">FOR AMALAPURAM</span>
              </div>
            </div>
            <p className="text-sm font-light leading-relaxed text-slate-500 max-w-sm">
            ...
            <div className="flex items-center space-x-4">
              <Link href="#" className="w-10 h-10 rounded-full border border-slate-200 flex items-center justify-center hover:bg-primary hover:border-primary hover:text-white transition-all duration-300 bg-white shadow-sm">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-12 lg:pl-16">
            <div>
              <h4 className="text-[10px] font-bold text-slate-900 mb-6 uppercase tracking-[0.2em] border-b border-slate-200 pb-4">Initiatives</h4>
            ...
            <div>
              <h4 className="text-[10px] font-bold text-slate-900 mb-6 uppercase tracking-[0.2em] border-b border-slate-200 pb-4">Civic Action</h4>
              <ul className="space-y-4 text-sm font-medium">
            ...
            <div>
              <h4 className="text-[10px] font-bold text-slate-900 mb-6 uppercase tracking-[0.2em] border-b border-slate-200 pb-4">Contact Office</h4>
              <ul className="space-y-5 text-sm font-medium text-slate-600">
                <li className="flex items-start space-x-4">
                  ...
                  <span className="leading-snug pt-1">MLA Office, Main Road, Amalapuram, AP</span>
                </li>
